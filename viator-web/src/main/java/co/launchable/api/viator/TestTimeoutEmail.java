...
public class TestTimeoutEmail {
    public static void main(String[] args) {
        ...
        ApplicationContext context = new FileSystemXmlApplicationContext("C:\\dev\\projects\\ASViatorIntegration\\src\\main\\webapp\\WEB-INF\\viator2-dispatcher-servlet.xml");
