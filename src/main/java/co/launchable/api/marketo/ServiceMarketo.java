...
public class ServiceMarketo {
    ...
    public ModelMap syncPendingVisitations(Integer aWorkers, boolean block) {
        ...
        return syncPendingObjects("marketo.syncVisitations.", "Visitation", numWorkers, block);
    }
    ...
    public ModelMap syncPendingConstituents(Integer aWorkers, boolean block) {
        ...
        return syncPendingObjects("marketo.syncConstituents.", "Constituent", numWorkers, block);
    }

    public ModelMap syncPendingOrders(Integer aWorkers, boolean block) {
        int numWorkers = aWorkers != null ? aWorkers : WORKERS_ORDERS;
        return syncPendingObjects("marketo.syncOrders.", "Order", numWorkers, block);
    }

    public ModelMap syncPendingEvents(Integer aWorkers, boolean block) {
        int numWorkers = aWorkers != null ? aWorkers : WORKERS_ORDERS;
        return syncPendingObjects("marketo.syncEvents.", "Event", numWorkers, block);
    }
    ...
    public ModelMap syncPendingOrderDetails(Integer aWorkers, boolean block) {
        ...
        return syncPendingObjects("marketo.syncOrderDetails.", "OrderDetail", numWorkers, block);
    }
    ...
    public ModelMap syncPendingInterests(Integer aWorkers, boolean block) {
        ...
        return syncPendingObjects("marketo.syncInterests.", "Interest_In", numWorkers, block);
    }
    ...
    public void sendEmailReport() {
        ...
        try {
            ...
            Template t = velocityEngine.getTemplate("templates/marketo/tpl_emailSynchronizationReport.vtl");
    ...
    public void sendDuplicatesReport() {
        ...
        try {
            ...
            if (rows.size() > 0) {
                ...
                StringWriter stringWriter = new StringWriter();
                Template t = velocityEngine.getTemplate("templates/marketo/tpl_emailDuplicatesReport.vtl");
                t.merge(vc, stringWriter);
