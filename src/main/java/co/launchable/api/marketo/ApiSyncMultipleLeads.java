...
public class ApiSyncMultipleLeads extends ApiBase implements Runnable, ReportableSynchronizationObject {
    ...
    private String prefixLocal = "marketo.syncMultipleLeads.";
    ...
    public static void main(String args[]) {
        ApplicationContext ctx = new FileSystemXmlApplicationContext("src/main/webapp/WEB-INF/marketo-dispatcher-servlet.xml");
