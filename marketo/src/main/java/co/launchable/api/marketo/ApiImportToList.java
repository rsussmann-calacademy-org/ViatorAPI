...
public class ApiImportToList {
    private String prefix = "co.launchable.api.marketo.marketo.";
    ...
    private String marketoServiceQnameUrl = "http://www.co.launchable.api.marketo.marketo.com/mktows/";
    ...
    private boolean submitListRows(String listName, String programName, String campaignName, ArrayOfString rows) {
        try {
            ...
            if (marketoProgramName != null && marketoCampaignName != null && listName != null) {
                ...
                //of X
                //rows.getStringItems().add("Awesomesauce,Developer,Code Slinger,Marketo,dawesomesauce@co.launchable.api.marketo.marketo.com");
