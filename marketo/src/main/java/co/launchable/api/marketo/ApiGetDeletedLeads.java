...
public class ApiGetDeletedLeads {
    ...
    public static void main(String[] args){
        ApplicationContext ctx = new FileSystemXmlApplicationContext("//Users/mike/Dropbox/Projects/ASViatorIntegration/src/main/webapp/WEB-INF/co.launchable.api.marketo.marketo-dispatcher-servlet.xml");
